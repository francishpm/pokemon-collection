...
export default function LoginPage() {
  ...
  return (
    <div className="flex min-h-screen w-full items-center justify-center bg-gradient-to-br from-slate-900 via-blue-950 to-slate-900 absolute inset-0 z-50 p-4">
      <Card className="w-full max-w-md shadow-2xl border-0 rounded-2xl overflow-hidden bg-white/95 backdrop-blur-sm">
        ...
        <CardHeader className="text-center pb-6 pt-8 space-y-3">
          <div className="mx-auto bg-blue-100 w-16 h-16 rounded-2xl flex items-center justify-center mb-2 shadow-inner transform rotate-3">
            <Sparkles className="w-8 h-8 text-blue-600" />
          </div>
          <CardTitle className="text-4xl font-extrabold tracking-tight text-slate-900">
            CardDex
          </CardTitle>
          <CardDescription className="text-base font-medium text-slate-500 px-2">
          ...
          <form onSubmit={handleAuth} className="space-y-5">
            ...
            {isRegistering && (
              <div className="space-y-2 relative">
                <label className="text-sm font-bold text-slate-700">Como quer ser chamado?</label>
            ...
            <div className="flex flex-col gap-3 pt-6">
              <Button type="submit" disabled={loading} className="h-12 font-bold text-md bg-blue-600 hover:bg-blue-700 w-full">
